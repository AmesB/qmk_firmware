...
[_COLEMAK] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, KC_DEL,  KC_LGUI, KC_LALT, KC_SPC,  LOWER,   KC_BSPC, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, OSM(MOD_RCTL)
),
...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_CAPS,       KC_DEL,  KC_LGUI, KC_LALT, KC_SPC,  LOWER,   KC_BSPC, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_RCTL
),


[_LOWER] = LAYOUT_preonic_grid(
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______,
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, _______,
  _______, _______, _______, _______, _______, KC_PSCR, KC_BSLS, KC_GRV,  _______, _______, _______, _______,
  _______, KC_INS,  _______, _______, _______, _______, RAISE,   _______, _______, _______, _______, _______
),
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  _______, RESET,   DEBUG,   _______, _______, _______, _______, _______, _______, _______, _______, RGB_HUI,
  _______, _______, _______, _______, _______, _______, _______, COLEMAK, QWERTY,  _______, _______, RGB_SAI,
